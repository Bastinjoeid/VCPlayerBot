...
async def start(client, message):
    ...
    buttons = [
        [
            InlineKeyboardButton('⚙️ Update Channel', url='https://t.me/+MuzlHNC1YZlhZGE1'),
            InlineKeyboardButton('🧩 Source', url='https://t.me/+PNP4hu6-0McyNDJl')
        ],
        [
...
async def repo_(client, message):
    buttons = [
        [
            InlineKeyboardButton('🧩 Repository', url='https://t.me/+PNP4hu6-0McyNDJl'),
            InlineKeyboardButton('⚙️ Update Channel', url='https://t.me/+FtQTqcvPBeE3OWNl'),     
        ],
        [
